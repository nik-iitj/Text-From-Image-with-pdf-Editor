...
public class ClassifiedText extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classified_text);
        ...
        Task<Text>result = recognizer.process(image).addOnSuccessListener(new OnSuccessListener<Text>() {
            ...
            public void onSuccess(@NonNull @NotNull Text text) {
                ...
                if(!resultText.isEmpty()){
                    ...
                    Toast.makeText(ClassifiedText.this, "No text recognized!!", Toast.LENGTH_SHORT).show();
